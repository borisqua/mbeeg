...
const
  ...
  , {EBMLReader, OVReader, Stimuli, Epochs, DSVProcessor, EpochSeries, DSHProcessor, Tools, Stringifier} = require('mbeeg')
  ...
  , epochSeries = new EpochSeries({
    ...
    , incremental: config.signal.dsp.horizontal.methods.absIntegral.incremental //true means moving calculation in to depth as specified
  })
