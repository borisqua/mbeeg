...
call pkg -t node6-win -c package_conf1.json -o ../../distr/ntstims.exe ntstims.js
...
call pkg -t node6-win -c package_conf2.json -o ../../distr/mbeegntsrv.exe mbeegntsrv.js
call pkg -t node6-win -c package_conf0.json -o ../../distr/tcpclient.exe tcpclient.js
