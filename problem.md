...
Соответственно интерпритация системой выбранного пользователем объекта может быть двух типов:
- команда/действие
- текст/информация
...
- второй использование групповых подсветок с целью сужения множества поиска, т. н. ммногомерный ввод.

Я предлагаю использовать оба подхода, т.к. они не конфликтуют, а наборот, способны дополнять друг друга.
...
- ещё есть методы Чапмена и ишо много других
Несмтря на большое разнообразие метрик для определения расстояния между словами наиболее популярная метрика судя по 
...
Смысл техники многомерного ввода в том, что для умеьшения общего количества стимулов с целью сокращения продолжительности
...
Примерный вид интерфеса представлен на рисунках ниже. Стимулирующие экранные клавиатуры построены на базе клавиатуры carousel
