//todo>> add error handling and use async/await everywhere where it is possible in the code
// something like this:
//async function someFunc(...){
//  try {
//    resource = await someAsyncFunctionThatSupportsPromiseInterface();
//    ..some synchronous operators
//  } catch(err) {
//    console.error(err);
//  }
//}
//
//todo>> fix callback functions signatures wherever it's possible to the standard form
//  something like this:
// callback(err, ...args)
//
//todo>> fix asynchronous functions signatures wherever it's possible to the standard form
//  something like this:
// function someAsyncFunction( callback, ...args){
//  ...
//  if (err) return callback(err);
//  ...
//  callback(null, ...args)
//
//todo>> all EventEmiters should be asynchronous and have standard form like this:
// class someEmitter extends require('events')
//  someAsyncAction(asyncFunc, ...args){
//   this.emit('begin');
//   ...
//   asyncFunc(...args, (err, result)=> {//result depends on asyncFunction purpose and signature of its callback function
//     if (err) {
...
//  }
//
// or like pure beauty (with and promises/async/await, console timing may be used for code inspection)
//
// class WithTime extends EventEmitter {
//   async someAsyncAction(asyncFunc, ...args) {
//     this.emit('begin');
//     try {
